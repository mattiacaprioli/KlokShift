-- Il reinvito di una scheda uscita deve riusare sia il member sia l'account
-- già collegato. La definizione precedente perdeva `v_found.user_id`, quindi
-- private.notify riceveva NULL; inoltre il CASE dello stato non era tipizzato
-- come member_status e PostgreSQL rifiutava il ramo prima della notifica.
-- Mantiene le protezioni HR introdotte da 20260922000200.
